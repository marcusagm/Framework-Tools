...
<form action="<?php echo $this->getUrlToDeleteSelected() ?>" method="post" class="grid_form">
	...
	<?php if( $this->getShowActionAdd() ) { ?>
		<a href="<?php echo $this->getUrlToAdd() ?>" title="" class="btn btn-primary"><i class="fas fa-fw fa-plus"></i> Adicionar</a>
	<?php } ?>
					...
					<td class="grid_column_actions">
						<div class="btn-group">
							<?php if( $this->getShowActionView() ) { ?>
								<a href="<?php echo $this->getUrlToView( array( 'id' => $value->id ) ) ?>" title="Visualizar" class="btn btn-outline-secondary btn-sm grid_button_view"><i class="fas fa-fw fa-eye"></i></a>
							<?php } ?>
							<?php if( $this->getShowActionEdit() ) { ?>
								<a href="<?php echo $this->getUrlToEdit( array( 'id' => $value->id ) ) ?>" title="Editar" class="btn btn-outline-secondary btn-sm grid_button_edit"><i class="fas fa-fw fa-edit"></i></a>
							<?php } ?>
