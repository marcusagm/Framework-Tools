<div class="form-group">
	...
	<div class="col-md-8">
		<input id="<?php echo $field['name'] ?>" name="<?php echo $field['name'] ?>" type="url" placeholder="" class="form-control input-md"<?php echo $field['required'] ? ' required' : '' ?> value="<?php echo $field['value'] ?>" tabindex="<?php echo $tabindex ?>">
