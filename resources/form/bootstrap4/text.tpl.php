<div class="form-group row">
	...
	<div class="col-md-8">
		<input id="<?php echo $field['name'] ?>" name="<?php echo $field['name'] ?>" type="text" placeholder="" maxlength="<?php echo $field['maxlength'] ?>" class="form-control"<?php echo $field['required'] ? ' required' : '' ?> value="<?php echo $field['value'] ?>">
