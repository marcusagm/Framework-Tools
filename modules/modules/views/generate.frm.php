            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="col-md-6">
                            <label class="control-label" for="template">Select the template</label>
                        ...
                        <div class="col-md-6">
                            <label class="control-label" for="template">Module group</label>
                            <input type="text" name="module_group" value="" class="form-control">
                        </div>
                    </div>
                        ...
                        <tbody>
                            <?php foreach( $this->model['fields'] as $field ) { ?>
                                <tr>
                                    ...
                                    <td><input type="text" name="input_label[<?php echo $field['Field'] ?>]" value="<?php echo Text::humanize( $field['Field'] ); ?>" class="form-control"></td>
                                    <td>
                                        <select name="input_type[<?php echo $field['Field'] ?>]" class="form-control">
                                            ...
                                            <option value="time"<?php echo stripos( $field['Type'], 'time' ) !== false && stripos( $field['Type'], 'timestamp' ) === false ? ' selected' : ''?>>Time</option>
                                            <option value="datetime"<?php echo (stripos( $field['Type'], 'datetime' ) !== false || stripos( $field['Type'], 'timestamp' ) !== false) && $field['Field'] !== 'created_at' && $field['Field'] !== 'updated_at' && $field['Field'] !== 'deleted_at' ? ' selected' : ''?>>Datetime</option>
